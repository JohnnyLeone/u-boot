...
int board_late_init(void)
{
	...
	if (val == 00000005){
		env_set("fdt_file", "/boot/imx6ull-voltastream-amp1.dtb");}
	else if (val == 00000004){
		env_set("fdt_file", "/boot/imx6ull-voltastream0.dtb");}
        ...
        env_set("fdt_file", "/boot/imx6ull-vsm1-0006.dtb");}
	else {
		env_set("fdt_file", "/boot/imx6ull-voltastream0.dtb");}
